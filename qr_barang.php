    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden">
        ...
        <div class="p-8 flex flex-col items-center justify-center bg-slate-50 border-b border-gray-100">
            <div class="p-4 bg-white rounded-xl shadow-md border border-gray-200">
                <img src="<?php echo $url_qr_api; ?>" alt="QR Code Barang"
                    class="w-48 h-48 transition-transform hover:scale-105 duration-200" />
            </div>
        ...
        <div class="p-6 space-y-3 bg-white">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <span
                        class="inline-block mt-0.5 px-2 py-0.5 rounded text-xs font-bold uppercase border <?php echo $barang['status'] === 'baik' ? 'bg-emerald-100 border-emerald-200 text-emerald-800' : 'bg-red-100 border-red-200 text-red-800'; ?>">
        ...
        <div class="p-4 bg-slate-50 border-t border-gray-100 flex gap-2">
            <a href="index.php?page=barang"
                class="w-full text-center px-4 py-2 border border-gray-300 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors">
                Kembali
            </a>
            <button onclick="window.print();"
                class="w-full bg-emerald-500 hover:bg-emerald-600 text-slate-950 font-bold px-4 py-2 rounded-lg text-sm flex items-center justify-center gap-1 shadow-sm transition-colors">
