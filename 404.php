<div class="min-h-[85vh] flex flex-col items-center justify-center px-lg mt-12 max-w-container-max mx-auto w-full animate-fade-in-up">
    ...
    <div class="relative w-64 h-64 flex items-center justify-center mb-xl">
        ...
        <div class="absolute inset-0 rounded-full border border-emerald-500/30 overflow-hidden">
            <div class="w-1/2 h-1/2 bg-gradient-to-tr from-emerald-500/0 via-emerald-500/5 to-emerald-500/20 origin-bottom-right absolute top-0 left-0 animate-radar-spin"></div>
        </div>

        <div class="relative z-10 flex flex-col items-center">
            <h1 class="text-7xl font-extrabold tracking-tighter text-slate-900 bg-gradient-to-r from-slate-900 via-emerald-500 to-slate-950 bg-clip-text text-transparent">
                404
            </h1>
    ...
    <div class="text-center max-w-md">
        ...
        <p class="font-body-md text-body-md text-on-surface-variant mb-xl leading-relaxed">
            Halaman atau data laboratorium yang Anda minta tidak terdaftar di dalam sistem radar logistik kami, atau sedang dalam pengembangan struktur database.
        </p>
...
<style>
    ...
    /* Animasi Memudar dan Naik Ke Atas */
    @keyframes fadeInUp {
        from {
            opacity: 0;
